        ...
        *,
        ...
        try:
            ...
            return PipelineResult(
                ...
                challenger_diagnostic=dict(self.runtime.challenger_diagnostic),
            )
...
def main():
    ...
    parser.add_argument("--existing-application-page-id", help="Optional existing Notion Applications page ID to update during re-evaluation.")
    ...
    result = asyncio.run(
        CareerOS(vault=vault, write_to_notion=not args.no_notion_write).process(
            profile,
            job,
